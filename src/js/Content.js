export const skills = [
    ...
    { title: "C#", description: "ASP.NET, WPF Basics" },
...
export const projects = [
    ...
    },
    {
        title: "Traffic app",
        description:
            "Mobile project for reporting police speed cameras and getting alerts from them",
        image: "/images/traffic-app.png",
        url: "/project/traffic-app",
        redirect: "https://gitlab.labranet.jamk.fi/mobile-project-rvj",
